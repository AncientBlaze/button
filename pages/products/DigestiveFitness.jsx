...
export default function DigestiveFitness({Name}) {
    ...
    const [selectedOption, setSelectedOption] = useState(749);
    const [selectedOption1, setSelectedOption1] = useState("1,656");
    const [selectedOption2, setSelectedOption2] = useState("55%");
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        const selectedoption =
                                            options[e.target.value].toString();
                        ...
                        <Tabs>
                            ...
                            <TabPanel className="text-lg">
                                <p className="py-5 text-sm text-[#727271]">
                                    Your Digestion's Defender is here! Elevate
                                    your immunity the natural way with Farm
                                    Naturelle Digestive Care Capsules. These
                                    capsules empower your digestion, building a
                                    strong defense against illnesses. Enjoy a
                                    healthier you, with a fortified immune
                                    system guarding against diseases.{" "}
                                </p>
                                <p></p>
                                <ul className="text-base">
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        ...
                                        Our herbal capsules gently encourage
                                        gastric glands to release essential
                                        juices. This aids in breaking down
                                        complex nutrients like proteins, fats,
                                        and sugars, promoting gut health. Bid
                                        farewell to indigestion, diarrhea, and
                                        nausea, and embrace a vibrant,
                                        discomfort-free life. Relieve stress,
                                        soothe anxiety, and ignite passion
                                        effortlessly. Discover newfound vitality
                                        and endurance in men while enhancing
                                    ...
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        ...
                                        Ajwain's active enzymes naturally
                                        enhances stomach acid flow. Experience
                                        soothing relief from indigestion,
                                        bloating, and gas.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b className="text-black">
                            ...
                            <TabPanel>
                                <p className="py-5 text-sm text-[#727271]">
                                    Jeera, Hing, Ajwain, Dhaniya, Triphla,
                                    Garcinia, Digestive Enzyme
                                </p>
                            </TabPanel>
                        </Tabs>
                    </div>
