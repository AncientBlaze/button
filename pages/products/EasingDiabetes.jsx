...
export default function EasingDiabetes() {
        ...
        <>
            ...
            <div className="p-10 w-full bg-[#F2F7E3] relative">
                ...
                <div className="w-full flex flex-col lg:flex-row-reverse xl:flex-row sm:flex-col justify-center items-start">
                    <div className="sm:w-full lg:w-1/2 lg:px-10 sm:px-20">
                        ...
                        <div className="w-full px-10 relative group">
                            <div className="absolute left-0 top-1/2 -translate-y-1/2 flex justify-between w-full">
                                <button
                        ...
                        <div className="text-[#313131] font-jost font-semibold py-10">
                            <ul>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Energize Your Health Naturally
                                </li>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Balancing Blood Sugar, the Natural Way
                                </li>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Giloy- BFF in Diabetes
                                </li>
                            </ul>
                        </div>
                        <div>
                                    ...
                                    <button
                                        onClick={() => {
                                            addToCart({
                                                ...
                                                ImageUrl:
                                                    "https://farmnaturelle.com/cdn/shop/files/1_288428b1-77a0-46c6-8cee-6abfac33eae1.png?v=1714049444",
                        ...
                        <Tabs>
                            ...
                            <TabPanel className="text-lg">
                                <p className="py-5 text-sm text-[#727271]">
                                    Farm Naturelle Diabetes Care Capsules aid in
                                    balancing blood sugar, igniting metabolism,
                                    and enhancing digestion. These capsules
                                    lovingly encourage insulin release,
                                ...
                                <ul className="text-base">
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        ...
                                        Transforming starch into vital energy,
                                        our herbal capsules offer holistic
                                        support for diabetes management.
                                        Quenching thirst and reducing frequent
                                        urination, they address common symptoms,
                                        naturally.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b>
                                            <span className="text-black">
                                                Balancing Blood Sugar, the
                                                Natural Way:
                                            </span>
                                        </b>{" "}
                                        Maintains healthy blood sugar for both
                                        type I and type II diabetes, harnessing
                                        the power of nature. Experience the
                                        goodness of our herbal capsules, working
                                        gently to support balanced glucose
                                        levels.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b className="text-black">
                                        ...
                                        Giloy Supports Insulin Production and
                                        Manages Blood Sugar. Embrace the natural
                                        goodness of Giloy, which aids your body
                                        in making insulin. This incredible herb
                                        also works to tackle extra glucose,
                                        leading to healthier blood sugar levels.{" "}
                                    </li>
                                </ul>
                                <p></p>
                            </TabPanel>
                            ...
                            <TabPanel>
                                <p className="py-5 text-sm text-[#727271]">
                                    Jamun seed, dry Karela, Dry Giloy tukdi, dry
                                    Tulshi, Panchtatva, Neem leaves, Fenugreek (
                                    Methi), Gudmar, Vijaysar, Amla Dry
                                </p>
                            </TabPanel>
                        </Tabs>
                    </div>
            ...
            <div className="h-[130vh] w-full">
                <div className="w-full h-full text-center py-2 font-jost relative">
                    <p className="text-[gray] py-10">Benefits</p>
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[40%] flex-col items-center justify-center">
                        <div className="w-full flex items-center rounded-[50%] bg-[#DEEEC0]">
                            <img
                                src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/B_Diabetic_Care_Juice.png?v=1703237231"
                                alt="Benefits"
                                loading="lazy"
                            />
                        </div>
                                ...
                                <div className="w-full text-wrap">
                                    <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                        ...
                                        <h4 className="text-2xl text-[#006944]">
                                            Healthy Tummy, Happy You
                                        </h4>
                                        <p>
                                            It is a natural blend packed with
                                            fibers that enhance digestion and
                                            promote healthy bowel movements.
                                            Embrace the power of anti-diabetic
                                            properties as it supports balanced
                                            insulin growth, fostering overall
                                            well-being.{" "}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-1">
                                ...
                                <div className="w-full">
                                    <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                        ...
                                        />
                                        <h4 className="text-2xl text-[#006944]">
                                            Age-old Secret for Your Tummy
                                        </h4>
                                        <p>
                                            Our herbal capsules bring you the
                                            power of nature's gentle touch to
                            ...
                            <div className="flex items-start gap-1">
                                <div className="w-full text-wrap">
                                    <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                        ...
                                        />
                                        <h4 className="text-2xl text-[#006944]">
                                            Natural Enzymes in Capsules
                                        </h4>
                                        <p>
                                            Packed with the essence of
                                            beneficial pro-biotics and natural
                                            enzymes, these capsules work
                                            harmoniously to support your
                                            digestion.{" "}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-1">
                                ...
                                <div className="w-full">
                                    <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                        ...
                                        <p>
                                            Naturally crafted to calm acid
                                            reflux and ease pesky heartburn,
                                            these capsules work harmoniously to
                                            enhance digestion. Discover the
                                            soothing power of pure, organic
                                            ingredients, giving you a happier,
                                            healthier gut.
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="flex justify-around py-10 px-10">
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Observed improvement in the Immune System{" "}
                            </p>
                        </div>
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            <div className="text-7xl text-[#006944] absolute -top-7  left-0">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Noticed improvement in digestion{" "}
                            </p>
                        </div>
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            <div className="text-7xl text-[#006944] absolute -top-7  left-0">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Noticed reduction in stomach acids
                            </p>
                        </div>
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            <div className="text-7xl text-[#006944] absolute -top-7  left-0">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                felt improved hunger at meal timings
                            </p>
                        </div>
                    </div>
                </div>
