...
export default function Hangover({ price }) {
    ...
    const [selectedOption1, setSelectedOption1] = useState("1,199");
    const [selectedOption2, setSelectedOption2] = useState("21%");
                ...
                <div className="w-full flex flex-col lg:flex-row-reverse xl:flex-row sm:flex-col justify-center items-start">
                    ...
                    <div className="flex flex-col font-bold font-jost justify-between">
                        <div className="text-3xl px-2 font-bold">
                            Anti Hangover Juice | Refresh & Recove |
                        </div>
                        ...
                        <div className="text-[#313131] font-jost font-semibold py-10">
                            <ul>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Your Natural Hangover Solution
                                </li>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Your Instant Rescue from Hangovers
                                </li>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Revitalize Rapidly
                                </li>
                        ...
                        <div>
                            <div className="font-light text-sm flex gap-2">
                                <select
                                    className="hidden border border-[#006944] py-2 text-left rounded-lg w-1/2 px-3 outline-none"
                                    onChange={(e) => {
                            ...
                            <div className="w-full bg-[#006944] text-white my-3 py-1 rounded-lg flex justify-center items-center">
                                <div className="flex gap-2 py-3 justify-center items-center">
                                    <button
                                        onClick={() => {
                                            addToCart({
                                                title: "Anti Hangover Juice | Refresh & Recove | Magic Man Booster",
                                                ImageUrl:
                                                    "https://farmnaturelle.com/cdn/shop/files/1_add0b8e6-5f55-4992-9b9b-347c69e6dec1.png?v=1714049136",
                        ...
                        <Tabs>
                            ...
                            <TabPanel className="text-lg">
                                <p className="py-5 text-sm text-[#727271]">
                                    Get relief from after celebrations like
                                    never before with our ready-to-drink
                                    anti-hangover shot. Alleviate nausea,
                                    dehydration, and discomfort effortlessly.
                                    This potent remedy, enriched with Moringa's
                                    vital nutrients, soothes hangover woes by
                                    replenishing lost vitamins. Its carb-rich
                                    content aids glucose metabolism, boosting
                                    energy levels. Hydrate & rejuvenate with our
                                    natural solution.{" "}
                                </p>
                                <p></p>
                                <ul className="text-base">
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        ...
                                        Get relief from motion sickness and
                                        nausea with ReviveEase, a ready-to-drink
                                        anti-hangover shot. This powerful remedy
                                        harnesses the potency of natural spices,
                                        making it an ideal choice to alleviate
                                        hangover symptoms. Swiftly recover with
                                        this simple, effective home cure that's
                                        trusted across India.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b>
                                            <span className="text-black">
                                                Your Instant Rescue from
                                                Hangovers:
                                            </span>
                                        </b>{" "}
                                        Say goodbye to morning grogginess! After
                                        a night of fun, excessive alcohol can
                                        disrupt your glucose metabolism. Our
                                        solution? A delicious snack packed with
                                        carbs and honey's fructose. These
                                        ingredients shoot up your blood sugar,
                                        giving you an energy boost when you need
                                        it most.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b className="text-black">
                                        ...
                                        Rehydrate swiftly and replenish lost
                                        sugars and vital salts with our
                                        ready-to-drink anti-hangover shot.
                                        Bounce back after a night out! Regain
                                        hydration, essential nutrients, and
                                        energy in one shot. Your go-to remedy,
                                        simplified for you. Say goodbye to
                                        hangovers the easy way.{" "}
                                    </li>
                                </ul>
                                <p></p>
                            </TabPanel>
                            ...
                            <TabPanel>
                                <p className="py-5 text-sm text-[#727271]">
                                    Ginger, Sugar, Salt, Ginseng, Moringa
                                </p>
                            </TabPanel>
                        </Tabs>
                    </div>
            ...
            <div className="h-[150vh] w-full">
                <div className="w-full h-full text-center py-2 font-jost relative">
                    ...
                    <p className="text-4xl font-medium text-[#006944]">
                        ...
                        Anti Hangover - Ready to drink shot{" "}
                    </p>
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[40%] flex-col items-center justify-center">
                        <div className="w-full flex items-center rounded-[50%] bg-[#DEEEC0]">
                            <img
                                src="../public/1_add0b8e6-5f55-4992-9b9b-347c69e6dec1-removebg-preview.png"
                                alt="Benefits"
                                loading="lazy"
                            />
                        </div>
                        <div className="absolute top-0 left-0 -translate-x-[82%] w-full flex flex-row-reverse h-auto text-sm">
                            <div className="flex items-start gap-1 p-10">
                                <div className="w-full text-wrap">
                                    <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                        ...
                                        <h4 className="text-2xl text-[#006944]">
                                            Say goodbye to morning-after misery
                                        </h4>
                                        <p>
                                            Our ready-to-drink anti-hangover
                                            shot is your ultimate companion
                                            after a night of fun. Banish thirst,
                                            nausea, and dehydration in one go.
                                            Specially formulated for quick
                                            relief, it's your ticket to feeling
                                            fresh and energized. Embrace your
                                            mornings without the hangover blues.{" "}
                                        </p>
                                    </div>
                                </div>
                                <img
                            ...
                            <div className="flex items-start gap-1">
                                ...
                                <div className="w-full">
                                    <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                        ...
                                        />
                                        <h4 className="text-2xl text-[#006944]">
                                            Your Ultimate Hangover Companion
                                        </h4>
                                        <p>
                                            Experience rejuvenation with our
                                            Moringa-infused anti-hangover shot.
                                            Replenish vital vitamins and
                                            nutrients lost overnight. Combat
                                            hangovers the natural way, as
                                            Moringa soothes and restores.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="w-full text-wrap">
                                    <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                        <img
                                            ...
                                            loading="lazy"
                                        />
                                        <h4 className="text-2xl text-[#006944] opacity-0">
            ...
            <div className="text-center px-10 text-xl">
                ...
                <div className="flex justify-around items-center w-full py-36">
                    <div className="w-[30%] h-48 bg-[#006944] rounded-xl text-8xl relative">
                        ...
                        <img
                            className="absolute opacity-0 -top-12 left-[50%] transform -translate-x-1/2 -translate-y-1/2"
                    ...
                    <div className="w-[30%] h-48 bg-[#99C459] rounded-xl text-8xl relative opacity-0">
                        <p className="absolute -top-10 left-10 transform -translate-x-1/2 -translate-y-1/2 text-[#D1E0D6]">
                            02
                        </p>
                        <img
                    ...
                    <div className="w-[30%] h-48 bg-[#006944] rounded-xl text-8xl relative opacity-0">
                        <p className="absolute -top-10 left-10 transform -translate-x-1/2 -translate-y-1/2 text-[#D1E0D6]">
                            03
                        </p>
                        <img
