...
export default function HealthyLiver() {
    ...
    const [selectedOption, setSelectedOption] = useState(849);
    const [selectedOption1, setSelectedOption1] = useState("1,099");
    ...
    const images = [
        ...
        {
            img: "https://farmnaturelle.com/cdn/shop/files/2_ae5db7fd-8cce-41cf-8ace-313417286bc9.jpg?v=1714049005",
            alt: "2nd",
        },
        {
            img: "https://farmnaturelle.com/cdn/shop/files/3_5e4c89b6-fcd8-4b5b-a0af-3dce6c683d26.jpg?v=1714049006",
            alt: "3rd",
        },
        {
            img: "https://farmnaturelle.com/cdn/shop/files/4_31c30531-54ec-4277-b5f7-f813d213d9c8.jpg?v=1714049005",
            alt: "4th",
        },
        {
            img: "https://farmnaturelle.com/cdn/shop/files/5_fb773b04-a5c8-44e6-b6cc-fa627d75f422.jpg?v=1714049004",
            alt: "5th",
        },
        {
                ...
                <div className="w-full flex justify-center items-start">
                    ...
                    <div className="flex flex-col font-bold font-jost justify-between">
                        <div className="text-3xl px-2 font-bold">
                            Smiling Liver Juice | Supports Liver Health |
                            ...
                            <div className="w-full bg-[#006944] text-white my-3 py-1 rounded-lg flex justify-center items-center">
                                <div className="flex gap-2 py-3 justify-center items-center">
                                    <button
                                        onClick={() => {
                                            addToCart({
                                                title: "Smiling Liver Juice | Supports Liver Health | Detoxifies the Liver",
                                                ImageUrl:
                                                    "https://farmnaturelle.com/cdn/shop/files/1_98b2b386-ba0d-488b-96fb-882a52e2d204.jpg?v=1714049005",
                        ...
                        <Tabs>
                            ...
                            <TabPanel className="text-lg">
                                <p className="py-5 text-sm text-[#727271]">
                                    Make your liver healthy the power of Aloe
                                    Vera! Our herbal capsules offer a natural
                                    path to a healthier liver. Packed with
                                    hydration and plant nutrients, they gently
                                    cleanse and rejuvenate your liver, promoting
                                    detoxification.{" "}
                                </p>
                                <p></p>
                                <ul className="text-base">
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        ...
                                        Aloe Vera juice, a tropical treasure
                                        that nourishes your liver. Hydrating and
                                        packed with enriching phytonutrients.
                                        Detoxify and invigorate your liver's
                                    ...
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b className="text-black">
                                            Reducing Liver Injuries:
                                        </b>{" "}
                                        Bolster your liver's defense with potent
                                        antioxidants and soothing
                                        anti-inflammatory support. It can reduce
                                        liver injury.{" "}
                                    </li>
                                </ul>
                                <p></p>
                            ...
                            <TabPanel>
                                <p className="py-5 text-sm text-[#727271]">
                                    Aloe Vera, Ginseng, Licorice, Garlic, Bhui
                                    Amla, Kalmegh, Kutki , Fresh Haldi
                                </p>
                            </TabPanel>
                        </Tabs>
                    </div>
                ...
                <div className="w-full h-full text-center py-2 font-jost relative">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[40%] flex-col items-center justify-center">
                        <div className="w-full flex items-center rounded-[50%] bg-[#DEEEC0]">
                            <img
                                src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/B_Smiling_Liver.png?v=1703237231"
                                alt="Benefits"
                                loading="lazy"
                            />
                        </div>
                                ...
                                <div className="w-full text-wrap">
                                    <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                        ...
                                        <h4 className="text-2xl text-[#006944]">
                                            Cleanse your liver with Garlic
                                        </h4>
                                        <p>
                                            The ancient potency of garlic, a
                                            nature's gem that bestows your liver
                                            with its mineral magic. Embrace a
                                            revitalized you as garlic's
                                            cleansing touch gently detoxifies
                                            your liver.{" "}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-1">
                                ...
                                <div className="w-full">
                                    <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                        ...
                                        />
                                        <h4 className="text-2xl text-[#006944]">
                                            Reverse Unhealthy Liver
                                        </h4>
                                        <p>
                                            Safeguarding your liver through
                                            potent antioxidants, antiviral
                                            might, and hepatoprotective prowess.
                                            Manage liver concerns with ease as
                                            they undo damage, making your liver
                                            stronger than ever. Embrace the
                                            goodness of 100% pure, organic
                                            ingredients.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-1">
                                <div className="w-full text-wrap">
                                    <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                        ...
                                        />
                                        <h4 className="text-2xl text-[#006944]">
                                            Gentle Care with Kalmegh
                                        </h4>
                                        <p>
                                            Experience the goodness of Kalmegh,
                                            your natural companion for a healthy
                                            liver. Packed with natural wonders,
                                            Kalmegh gently nurtures your liver,
                                            aiding in managing fatty liver
                                            concerns. Its special elements work
                                            to naturally support healthy lipid
                                            levels, promoting overall wellness.{" "}
                                        </p>
                                    </div>
                                </div>
                                <img
                            ...
                            <div className="flex items-start gap-1">
                                ...
                                <div className="w-full">
                                    <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                        ...
                                        />
                                        <h4 className="text-2xl text-[#006944]">
                                            Guardian for Your Liver Health
                                        </h4>
                                        <p>
                                            Our herbal capsules act as a
                                            safeguard, curbing substances that
                                            pose a threat to your liver's
                                            well-being.
                                        </p>
                                    </div>
                                </div>
