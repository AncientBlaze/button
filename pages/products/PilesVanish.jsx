...
export default function PilesVanish() {
    ...
    const [selectedOption, setSelectedOption] = useState(Number(949));
    const [selectedOption1, setSelectedOption1] = useState("2,056");
    const [selectedOption2, setSelectedOption2] = useState("23%");
                ...
                <div className="w-full flex justify-center items-start">
                    <div className="w-1/2 px-10">
                            ...
                            >
                                <div>
                                    <img
                                        ...
                                        src="//farmnaturelle.com/cdn/shop/files/1_dce904a4-a7e3-4499-94b1-9bc050c38f14.jpg?v=1714048953"
                                        alt="Piles Vanish Juice |Supports Digestive Health | Reduces Inflammation"
                                        loading="lazy"
                                    />
                                </div>
                                <div>
                                    <img
                                        src="//farmnaturelle.com/cdn/shop/files/2_659d3110-4c28-461e-8de2-825ac8626235.jpg?v=1714048972"
                                        alt="2rd"
                                        loading="lazy"
                                    />
                                </div>
                                <div>
                                    <img
                                        src="https://farmnaturelle.com/cdn/shop/files/3_4ec6e52d-7693-40b2-a2ee-7a4253bc2398.jpg?v=1714048972"
                                        alt="3rd"
                                        loading="lazy"
                                    />
                                </div>
                                <div>
                                    <img
                                        src="https://farmnaturelle.com/cdn/shop/files/4_703118c6-4d0a-49b3-9d95-6e71ae57e440.jpg?v=1714048973"
                                        alt="4th"
                                        loading="lazy"
                                    />
                                </div>
                                <div>
                                    <img
                                        src="https://farmnaturelle.com/cdn/shop/files/5_87fe841f-d6b2-47e4-9d4b-6386dcda1faa.jpg?v=1714048973"
                                        alt="5th"
                                        loading="lazy"
                                    />
                                </div>
                                <div>
                                    <img
                                        src="https://farmnaturelle.com/cdn/shop/files/6_c9376425-d06e-41ea-b1fa-256469ba8af7.jpg?v=1714048972"
                                        alt="6th"
                                        loading="lazy"
                                    />
                                </div>
                        ...
                        <div className="w-full px-20 relative">
                            <div className="absolute left-0 top-1/2 -translate-y-1/2 flex justify-between w-full px-14 z-10">
                                <button
                            ...
                            >
                                <div>
                                    <img
                                        height={120}
                                        width={120}
                                        src="https://farmnaturelle.com/cdn/shop/files/1_dce904a4-a7e3-4499-94b1-9bc050c38f14_240x.jpg?v=1714048953"
                                        alt="1st"
                                    />
                                </div>
                                <div>
                                    <img
                                        height={120}
                                        width={120}
                                        src="https://farmnaturelle.com/cdn/shop/files/2_659d3110-4c28-461e-8de2-825ac8626235.jpg?v=1714048972"
                                        alt="2nd"
                                    />
                                </div>
                                <div>
                    ...
                    <div className="flex flex-col font-bold font-jost justify-between">
                        <div className="text-3xl px-2 font-bold">
                            Piles Vanish Juice |Supports Digestive Health |
                        ...
                        <div className="text-[#313131] font-jost font-semibold py-10">
                            <ul>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Healing Comfort for Piles
                                </li>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Gentle Relief for Peptic Ulcers & Piles
                                </li>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Nature&apos;s Soothing Care for Piles
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <div className="w-full bg-[#006944] text-white my-3 py-1 rounded-lg flex justify-center items-center">
                                <div className="flex gap-2 py-3 justify-center items-center">
                                    <button
                                        onClick={() => {
                                            addToCart({
                                                title: "Piles Vanish Juice |Supports Digestive Health | Reduces Inflammation",
                                                ImageUrl:
                                                    "https://farmnaturelle.com/cdn/shop/files/1_dce904a4-a7e3-4499-94b1-9bc050c38f14.jpg?v=1714048953",
                        ...
                        <Tabs>
                            ...
                            <TabPanel className="text-lg">
                                <p className="py-5 text-sm text-[#727271]">
                                    Piles care Combo is beneficial in treating
                                    all kinds of piles and constipation. It also
                                    strengthens the digestive system. The
                                    formulation of the product is made from 17
                                    unique herbs.{" "}
                                </p>
                                <p></p>
                                <ul className="text-base">
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        ...
                                        Seek relief with our Piles Care Combo,
                                        enriched with natural analgesic
                                        qualities. Ease discomfort, soothe pain,
                                        and support swift wound recovery.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b>
                                            <span className="text-black">
                                                Gentle Relief for Peptic Ulcers
                                                &amp; Piles:
                                            </span>
                                        </b>{" "}
                                        This blend of herbal juices offers a
                                        potential solution to halt internal
                                        bleeding caused by peptic ulcers and
                                        internal piles. Discover the natural
                                        path to comfort and well-being, as you
                                        enjoy the benefits of our pure, organic,
                                        and gentle remedies.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b className="text-black">
                                            Nature&apos;s Soothing Care for
                                            Piles:
                                        </b>{" "}
                                        Get the gentle touch of neem leaves,
                                        brimming with natural anti-inflammatory
                                        strength. Embrace relief as they aid in
                                        curbing harmful bacteria and toxins,
                            ...
                            <TabPanel>
                                <p className="py-5 text-sm text-[#727271]">
                                    Neem leaves, Pipal, Priyangu, Nagkesar, Amla
                                    Dry, Nishot, Amalthas, Kutki, Suran,
                                    Ashwaganda, Barad, Saunf, Cirayta, Vidang,
                                    Bealgiri, Harad
                                </p>
                            </TabPanel>
                        </Tabs>
                ...
                <div className="w-full h-full text-center py-2 font-jost relative">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[40%] flex-col items-center justify-center">
                        <div className="w-full flex items-center rounded-[50%] bg-[#DEEEC0]">
                            <img
                                src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/M_K07712.png?v=1703160000"
                                alt="Benefits"
                                loading="lazy"
                            />
                        </div>
                            ...
                            <div className="flex items-start gap-1">
                                <div className="w-full text-wrap">
                                    <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                        <img
                                            src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/piles_1.png?v=1703664516"
                                            title=""
                                            width="auto"
                                            height="auto"
                                            loading="lazy"
                                        ...
                                        <h4 className="text-2xl text-[#006944]">
                                            Get Comfort with Our Piles Care
                                            Elixir
                                        </h4>
                                        <p>
                                            Revitalize with our Piles Care
                                            Elixir, thoughtfully crafted to
                                            naturally ease discomfort. Witness
                                            potential reduction in pile lumps,
                                            soothing of inflammation, relief
                                            from pain, and cessation of
                                            bleeding.{" "}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-1">
                                ...
                                <div className="w-full">
                                    <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                        <img
                                            src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/piles_2.png?v=1703664515"
                                            title=""
                                            width="auto"
                                            height="auto"
                                            loading="lazy"
                                        />
                                        <h4 className="text-2xl text-[#006944]">
                                            Gentle Relief for Piles
                                        </h4>
                                        <p>
                                            Harnessing the power of nature, this
                                            blend might assist in managing
                                            excessive bleeding caused by piles.
                                            Embrace the goodness of pure,
                                            organic ingredients, and take a step
                                            towards a more comfortable and
                                            natural solution.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="absolute bottom-0 right-0 translate-x-[82%] translate-y-20 w-full flex flex-row-reverse h-auto">
                            <div className="flex items-start gap-1">
                                ...
                                <div className="w-full">
                                    <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                        <img
                                            src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/piles_3.png?v=1703664516"
                                            title=""
                                            width="auto"
                                            height="auto"
                                            loading="lazy"
                ...
                <div className="flex justify-around items-center w-full py-36">
                    <div className="w-[30%] h-48 bg-[#006944] rounded-xl text-8xl relative">
                        ...
                        <img
                            ...
                            src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/1_Piles_vanish.png?v=1703237213"
                            alt=""
                        />
                    ...
                    <div className="w-[30%] h-48 bg-[#99C459] rounded-xl text-8xl relative">
                        ...
                        <img
                            className="absolute -top-12 left-[50%] transform -translate-x-1/2 -translate-y-1/2"
                            src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/2_Piles_vanish.png?v=1703237213"
                            alt=""
                        />
                    ...
                    <div className="w-[30%] h-48 bg-[#006944] rounded-xl text-8xl relative">
                        ...
                        <img
                            className="absolute -top-12 left-[50%] transform -translate-x-1/2 -translate-y-1/2"
                            src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/3_Piles_vanish.png?v=1703237213"
                            alt=""
                        />
                    ...
                    <div className="flex justify-around py-10 px-10">
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Obvserved relief from constipation
                            </p>
                        </div>
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            <div className="text-7xl text-[#006944] absolute -top-7  left-0">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Noticed decrease in swelling in the anus region
                            </p>
                        </div>
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            <div className="text-7xl text-[#006944] absolute -top-7  left-0">
                        ...
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Noticed reduction in bleeding from piles
                            </p>
                        </div>
                    </div>
                </div>
