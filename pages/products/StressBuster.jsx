...
export default function StressBuster() {
    ...
    const [selectedOption, setSelectedOption] = useState(799);
    const [selectedOption1, setSelectedOption1] = useState("1,756");
                    ...
                    <div className="flex flex-col font-bold font-jost py-5 justify-between">
                        ...
                        <div className="text-[#313131] font-jost font-semibold py-10">
                            <ul>
                                ...
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Find Peace with Jatamansi Herbal Juice
                                </li>
                            </ul>
                        </div>
                        <div>
                                    ...
                                    <button
                                        onClick={() => {
                                            addToCart({
                                                title: "GLOWING WOMEN",
                                                ImageUrl:
                                                    "https://farmnaturelle.com/cdn/shop/files/1_b7ef26c6-de94-42c9-b88e-e9ffd7fb8c24.png?v=1714049406",
                        ...
                        <Tabs>
                            ...
                            <TabPanel className="text-lg">
                                <p className="py-5 text-sm text-[#727271]">
                                    Thoughtfully crafted to create a soothing
                                    stress-relief regimen. Effortlessly unwind
                                    as these natural elixirs gently ease away
                                    the burdens of daily life, promoting a
                                    serene sense of calm. Experience the power
                                    of nature's embrace, as our juices assist in
                                    alleviating overall stress, allowing you to
                                ...
                                <ul className="text-base">
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b className="text-black">
                                            Ashwagandha: Your Natural Stress
                                            Solution:
                                        </b>{" "}
                                        Experience tranquility with Ashwagandha,
                                        renowned for its remarkable
                                        stress-relief abilities. Embrace
                                        serenity as this ancient herb gently
                                        diminishes stress and anxiety, promoting
                                        a peaceful mind. Our herbal juices
                                        harness the power of Ashwagandha,
                                        providing you with a holistic way to
                                        soothe your senses and find balance in
                                        your daily life.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b>
                                        ...
                                        Your Stress-Relief BFF: It gently
                                        influences key enzymes linked to stress,
                                        curbing stress and anxiety. Your mood
                                        receives a blissful lift, while cortisol
                                        (stress hormone) levels diminish.
                                        Elevating serotonin levels, Brahmi
                                        becomes your ultimate stressbuster,
                                        paving the way for inner calm and
                                        harmony.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b className="text-black">
                                            Find Peace with Jatamansi Herbal
                                            Juice:
                                        </b>{" "}
                                        Discover the ancient wisdom of Ayurveda
                                        that identifies Vata as the orchestrator
                                        of body and nervous system harmony.
                                        Unveil serenity as Jatamansi, a soothing
                                        herb, alleviates anxiety by restoring
                                        Vata balance. Reclaim peace, as nature's
                                        essence flows through every drop of our
                                        herbal juice, supporting your journey to
                                        a tranquil mind and body.{" "}
                                    </li>
                                </ul>
                                <p></p>
                            </TabPanel>
                            ...
                            <TabPanel>
                                <p className="py-5 text-sm text-[#727271]">
                                    Ashwagandha, Brahmi, Jatamansi, Kava, tulsi,
                                    Shankhpushpi
                                </p>
                            </TabPanel>
                        </Tabs>
                                ...
                                <div className="w-full text-wrap">
                                    <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                        ...
                                        <h4 className="text-2xl text-[#006944]">
                                            Kava Kava to Your Rescue
                                        </h4>
                                        <p>
                                            Experience serenity with our Kava
                                            Kava herbal juice. Crafted from
                                            nature's embrace, it gently eases
                                            worries, like a soothing balm for
                                            the mind. Relish the calming magic,
                                            as tension melts away, leaving only
                                            peace. Indulge in nature's remedy
                                            for a serene soul.{" "}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-1">
                                ...
                                <div className="w-full">
                                    <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                        ...
                                        />
                                        <h4 className="text-2xl text-[#006944]">
                                            The Magic of Shankh Pushpi
                                        </h4>
                                        <p>
                                            This ancient herbal gem gently
                                            soothes the mind, melting away
                                            stress and anxiety. Feel the embrace
                                            of calmness while enhancing memory
                                            through its Medhya wonder—nourishing
                                            your intelligence. Elevate your
                                            wellness journey with our pure,
                                            natural, and organic herbal juices.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="flex justify-around py-10 px-10">
                        <div className="w-[23%] h-40 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Noticed reduction in overall stress
                            </p>
                        </div>
                        <div className="w-[23%] h-40 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            <div className="text-7xl text-[#006944] absolute -top-7  left-0">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Obvserved elevation in good mood
                            </p>
                        </div>
                        <div className="w-[23%] h-40 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            <div className="text-7xl text-[#006944] absolute -top-7  left-0">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Noticed better mood with family and friends to
                                enjoy life
                            </p>
                        </div>
                        <div className="w-[23%] h-40 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
