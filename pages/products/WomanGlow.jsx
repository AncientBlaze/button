...
export default function WomanGlow({ price }) {
    ...
    const [selectedOption1, setSelectedOption1] = useState("1,956");
                    ...
                    <div className="flex flex-col font-bold font-jost py-5 justify-between">
                        ...
                        <div className="text-[#313131] font-jost font-semibold py-10">
                            <ul>
                                ...
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Biotin-rich Capsules
                                </li>
                                <li className="bg-[url(https://farmnaturelle.com/cdn/shop/files/np_tick_1308418_000000_svg.svg?v=1696564417)] bg-no-repeat bg-[1%] p-2 px-10">
                                    Pomegranate’s Goodness for You
                                </li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <Tabs>
                            ...
                            <TabPanel className="text-lg">
                                <p className="py-5 text-sm text-[#727271]">
                                    Farm Naturelle herbal capsules gracefully
                                    diminish wrinkles and fine lines, and
                                    youthful skin. Plant-based collagen enhances
                                    skin's suppleness, while biotin fosters
                                    hydration, imparting a silky texture.
                                    Pomegranate, a potent antioxidant,
                                    invigorates skin, accelerating cell renewal
                                    for an age-defying allure.{" "}
                                </p>
                                <p></p>
                                <ul className="text-base">
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        ...
                                        Our herbal capsules work wonders in
                                        minimizing wrinkles and fine lines,
                                        leaving your face and neck looking
                                        youthful. Experience enhanced skin
                                        elasticity as our veg collagen
                                        formulation restores and rejuvenates,
                                        giving you firm and supple skin.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b>
                                        ...
                                        Revitalizing from within, our herbal
                                        capsules, rich in biotin, work wonders
                                        for your skin. Experience enhanced
                                        hydration, a silky-smooth texture, and a
                                        radiant appearance.{" "}
                                    </li>
                                    <li className="text-[#727271] py-2 px-10 bg-[url(https://farmnaturelle.com/cdn/shop/files/Vector_7.svg?v=1696824655)] bg-no-repeat bg-[1%]">
                                        <b className="text-black">
                                        ...
                                        With its natural antioxidants, our
                                        herbal capsules turn back the clock on
                                        aging. Experience the marvel as it
                                        accelerates cell renewal, revealing your
                                        radiant essence. Embrace the power of
                                        nature for timeless beauty and
                                        rejuvenation.{" "}
                                    </li>
                                </ul>
                                <p></p>
                            ...
                            <TabPanel>
                                <p className="py-5 text-sm text-[#727271]">
                                    Veg Collagen, Biotin, Pomegranate,
                                    Shatavari, Mulethi
                                </p>
                            </TabPanel>
                        </Tabs>
                                ...
                                <div className="w-full text-wrap">
                                    <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                        ...
                                        <h4 className="text-2xl text-[#006944]">
                                            Age-Defying Magic of Shatavari
                                        </h4>
                                        <p>
                                            Shatavari is a cherished natural gem
                                            known for its age-reversing prowess.
                                            Unveil nature's secret to graceful
                                            aging with our pure and organic
                                            herbal capsules. Shatavari, your
                                            ultimate ally for radiant skin,
                                            strong vitality, and a youthful
                                            spirit.{" "}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-1">
                                ...
                                <div className="w-full">
                                    <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                        ...
                                        <p>
                                            With the magic of nature with our
                                            herbal capsules, brimming with
                                            beneficial compounds and
                                            antioxidants. Revel in skin-soothing
                                            and brightening wonders that gently
                                            fade dark spots, creating an even,
                                            luminous skin tone.
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="flex justify-around py-10 px-10">
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Noticed improvement in skin health
                            </p>
                        </div>
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            <div className="text-7xl text-[#006944] absolute -top-7  left-0">
                            ...
                            <p className="text-xl text-left absolute top-1/2 left-0 px-5">
                                Noticed improvement in the elasticity of skin.
                            </p>
                        </div>
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
                            <div className="text-7xl text-[#006944] absolute -top-7  left-0">
                            ...
                            <p className="text-xl text-left absolute top-1/2 -translate-y-1/2 left-0 px-5">
                                Observed helpful fade dark spots and improve an
                                uneven skin tone
                            </p>
                        </div>
                        <div className="w-[23%] h-32 bg-white rounded-3xl text-center text-[#B3B3B3] font-light p-5 relative">
