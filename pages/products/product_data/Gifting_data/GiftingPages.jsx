...
import { products } from "../giftProduct_data";
import { BiPlus } from "react-icons/bi";

export default function GiftingPages({
    name,
    Name,
    price,
    price1,
    ...
    return (
        <div>
                ...
                <div className="w-full flex justify-center items-start">
                    <div className="w-1/2 px-10">
                        ...
                        <div className="w-full px-20 relative group">
                            <div className={`absolute ${images.length > 1 ? 'flex' : 'hidden'} left-0 top-1/2 -translate-y-1/2 flex justify-between w-full px-10`}
                            >
                                <button
                    ...
                    <div className="flex flex-col font-bold font-jost justify-between">
                        ...
                        <div>
                            ...
                            <div className="font-light text-sm flex gap-2">
                                <select
                                    className={`border border-[#006944]  py-2 text-left rounded-lg w-1/2 px-3 outline-none ${value ?? "hidden"}`}
                                    onChange={(e) => {
                                ...
                                <div className="flex gap-2 justify-center items-center w-1/3 border border-[#006944] rounded-lg px-5">
                                    <button
                                        className="w-1/2 text-[#006944] text-center"
                                        onClick={() => {
                                            if (count > 1) {
                                                setCount(count - 1);
                                            }
                                    ...
                                    <div className="text-[#006944] text-2xl font-medium w-full h-full flex justify-center items-center border-l border-r border-black">
                                        {count ? count : 1}
                                    </div>
                                    <button
                                        className="w-1/2 text-[#006944] text-center"
            ...
            <div className={`w-full h-screen p-10 bg-[#F2F7E3] ${T1Text ?? T2Text ?? T3Text ? "block" : "hidden"}`}>
                <div className="w-full h-[1px] bg-[#F2F7E3]">
                    <div className={`w-full px-16 py-5 bg-[#F2F7E3]`}>
                        <Tabs>
                            <TabList className="flex justify-between py-2">
                                <Tab className="outline-none cursor-pointer font-medium font-jost text-xl text-[#006944] focus:underline">
                                    Product Details
                                </Tab>
                            </TabList>
            ...
            <div className="w-full h-auto text-center text-[#006944] text-4xl py-10 font-jost bg-[#F8F7F1]">
                <div>
                    <p>
                        You May{" "}
