...
export default function ShilajitHoneyPages({
    name,
    Name,
    price,
    price1,
                                ...
                                <div className="flex items-start gap-1">
                                    <div className="w-full text-wrap">
                                        <div className="w-auto text-center flex flex-col justify-center items-center -my-5">
                                            <img
                                                src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/Stemina.png?v=1711175026"
                                                title=""
                                                width="52px"
                                                height="42px"
                                                loading="lazy"
                                ...
                                <div className="flex items-start gap-1">
                                    <div className="w-full text-wrap">
                                        <div className="text-[#006944] w-auto text-center flex flex-col justify-center items-center -my-5">
                                            <img
                                                src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/Joint_health.png?v=1711175026"
                                                title=""
                                                width="50px"
                                                height="50px"
                                                loading="lazy"
                            ...
                            <div className="text-[#006944] absolute bottom-0 right-0 translate-x-[82%] translate-y-20 w-full flex flex-row-reverse h-auto">
                                <div className="flex items-start gap-1">
                                    ...
                                    <div className="w-full">
                                        <div className="w-full -my-5 text-center flex flex-col justify-center items-center text-sm">
                                            <img
                                                src="https://cdn.shopify.com/s/files/1/0781/6711/4011/files/performance.png?v=1711175026"
                                                title=""
                                                width="42px"
                                                height="auto"
                                                loading="lazy"
