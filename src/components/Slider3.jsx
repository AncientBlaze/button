            ...
            <div className="w-full h-screen flex">
                ...
                <div className="w-2/3 h-full bg-transparent flex items-center">
                    <div className="w-full h-full flex justify-end items-center z-0">
                        <Link to={"/collections/ghee/products/a2-sahiwali-ghee"}>
                        ...
                        <Link to={"/collections/ghee/products/a2-desi-cow-ghee-from-grass-fed-gir-cows-vedic-bilona-method-curd-churned-golden-grainy-aromatic-keto-friendly-non-gmo-and-a-wooden-spoon"}>
